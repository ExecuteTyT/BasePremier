        ...
        - generic [ref=e15]:
            ...
            - generic [ref=e282]:
                ...
                - generic [ref=e288]:
                    - generic [ref=e290]:
                        - blockquote [ref=e291]:
                            - paragraph [ref=e292]: "«Долго не мог найти барбера под себя — обошёл несколько заведений в Казани. В BASE Premier с первого визита понял: это то, что нужно. Марат работает методично, без спешки. Результат — именно то, что хотел.»"
                        - generic [ref=e293]: Клиент BASE Premier · Сентябрь 2025
                    - generic [ref=e295]:
                        - tablist "Переключение отзывов" [ref=e296]:
                            - tab "Отзыв 1" [selected] [ref=e297]
                            - tab "Отзыв 2" [ref=e299]
                            - tab "Отзыв 3" [ref=e301]
                            - tab "Отзыв 4" [ref=e303]
                            - tab "Отзыв 5" [ref=e305]
                        - generic [ref=e307]: 01 / 05
            - generic [ref=e309]:
                - generic [ref=e310]:
